...
fun main () {
    ...
    val courseFiles = arrayOf("car-f-92.crs")//"car-s-91.crs", "car-f-92.crs", "kfu-s-93.crs", "tre-s-92.crs", "yor-f-83.crs")
    val studentFiles = arrayOf("car-f-92.stu")//"car-s-91.stu", "car-f-92.stu", "kfu-s-93.stu", "tre-s-92.stu", "yor-f-83.stu")
    ...
    for (i in courseFiles.indices) {
        ...
        */
        ...
        for (x in 0..courseGraph.students.size) {
