...
fun main () {
    ...
    val courseFiles = arrayOf("car-s-91.crs")//"car-s-91.crs", "car-f-92.crs", "kfu-s-93.crs", "tre-s-92.crs", "yor-f-83.crs")
    val studentFiles = arrayOf("car-s-91.stu")//"car-s-91.stu", "car-f-92.stu", "kfu-s-93.stu", "tre-s-92.stu", "yor-f-83.stu")
    ...
    for (i in courseFiles.indices) {
        ...
        println("${courseFiles[i]}, ${solver.colorsUsed}, $penalty")
        ...
        println("${courseFiles[i]}, ${solver.colorsUsed}, $penalty2")
